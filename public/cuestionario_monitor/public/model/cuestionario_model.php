...
class cuestionario_model extends Model {
    ...
    public function actualizarPreguntaMA($titulo, $col1, $col2, $col3, $col4, $alt, $idpreg) { //MATRICIAL	
    ...
    public function registrarPreguntaMA($titulo, $col1, $col2, $col3, $col4, $alt) { //MATRICIAL	
