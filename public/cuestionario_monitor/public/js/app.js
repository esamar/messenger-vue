        ...
        if ($("#morris_stacked").length) {
            var e = [ {
                ...
                t = {
                    ...
                    xkey: "y",
                    ykeys: ["a", "b","c"],
                    labels: ["Pendiente", "No ingreso","Completo"],
                    fillOpacity: .6,
                    hideHover: "auto",
                    behaveLikeLine: !0,
                    resize: !0,
                    ...
                    lineColors: [MaterialLab.APP_COLORS.mw_purple, MaterialLab.APP_COLORS.success,MaterialLab.APP_COLORS.primary],
                    barColors: [MaterialLab.APP_COLORS.mw_purple, MaterialLab.APP_COLORS.success,MaterialLab.APP_COLORS.primary]
                };
            t.element = "morris_stacked", t.stacked = !0, Morris.Bar(t), Morris.Donut({
